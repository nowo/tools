...
function GradientCSS(options) {
    ...
    if (!info || !options) {
        ...
        },
        {
            ...
            'htmlBlock': _createStopMarker('opacity', 1, {
                'opacity': 1,
                'location': 100
            }, this.widthDefault)
        }];
        ...
        this.colorStop = [{
            'color': this.colorDefault.clone(), 'location': 0,
            'htmlBlock': _createStopMarker('color', 0, {
        ...
        },
        {
            ...
            'htmlBlock': _createStopMarker('color', 1, {
                'color': this.colorDefault,
                'location': 100
            }, this.widthDefault)
        }];
...
function _reverseMarks(list, width, typeOfMarker) {
    ...
    if (typeOfMarker == 'color') {
        ...
        for (i = 0; i < list.length; i++) {
            ...
            color = new UserColor({
                color: { r: list[i].opacity, g: list[i].opacity, b: list[i].opacity },
                format: 'rgb'
            });
